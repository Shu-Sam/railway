...
class Menu
  ...
  def show_main_menu
    ...
    puts '19. Изменить скорость поезду'
    puts '0. Выход'
  end
  ...
  def runner
    loop do
      ...
      begin
        ...
        when CHANGE_SPEED then inc_speed_with_history
  ...
  def inc_speed_with_history
    puts 'Введите индекс поезда, которому нужно изменить скорость:'
    railway.trains_with_index
    train_index = gets.chomp.to_i

    puts 'Введите число, на которое нужно изменить скорость:'
    speed = gets.chomp.to_i
    railway.inc_speed_with_history(train_index, speed)
  end
